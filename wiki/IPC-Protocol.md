...
- `create_thread`, `update_thread_parameters`, and `confirm_thread` add the semantic thread feature contract. This first pass stores cosmetic/modeled thread intent for holes and cylindrical targets; modeled helical booleans are staged behind the helix/sweep stack.
